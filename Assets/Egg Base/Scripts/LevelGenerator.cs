...
public class LevelGenerator : MonoBehaviour {
	...
	public void ChangeColor(int colorSet)
	{
		if (colorSet == 0)
		{
			...
			cameraColor.backgroundColor = new Color(0.4196078f, 0.6470588f, 0.627451f, 1);
		...
		else if (colorSet == 1)
		{
			...
			cameraColor.backgroundColor = new Color(0.8705882f, 0.7058824f, 1f, 1);
		...
		else if (colorSet == 2)
		{
			...
			cameraColor.backgroundColor = new Color(0.3882353f, 0.6901961f, 0.5882353f, 1);
